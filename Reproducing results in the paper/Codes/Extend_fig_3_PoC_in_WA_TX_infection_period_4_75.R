##########################
# Code for figure 3 in the Extended data figures section
# 
...
save_file_path = "./Reproducing results in the paper/Results/Extended_fig_3/"

ggarrange( col_1, ggarrange(row_1, row_2, nrow = 2, ncol=1), nrow = 1, ncol = 2, widths = c(1,2) )%>%
  ggsave(file=paste0(save_file_path, "Results_in_WA_TX_infection_period_4.75.eps"), width = 36, height = 18, units = "cm")
